            ...
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle" type="button"
                        ...
                        @php
                            $headerProfileImg =
                                auth()->user() && auth()->user()->profile_img
                                    ? asset(auth()->user()->profile_img)
                                    : asset('assets/images/user.png');
                        @endphp
                        <img src="{{ $headerProfileImg }}" alt="image"
                        ...
                        <div
                            ...
                            <div>
                                <h6 class="text-lg text-primary-light fw-semibold mb-2">
                                    {{ auth()->user() ? auth()->user()->name : 'User' }}</h6>
                                <span
                                    class="text-secondary-light fw-medium text-sm">{{ auth()->user() ? auth()->user()->role ?? 'User' : 'User' }}</span>
                            </div>
                        ...
                        <ul class="to-top-list">
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-danger d-flex align-items-center gap-3 w-100 text-start border-0 bg-transparent">
